...
public:
	 ...
	 */
	virtual Value reduce(RowWithKey_Iterator begin, RowWithKey_Iterator end) = 0;
	 ...
	 * previous run.
	 */
	virtual Value rereduce(ReducedRow_Iterator begin, ReducedRow_Iterator end) = 0;
...
public:
	...
	virtual Value reduce(RowWithKey_Iterator begin, RowWithKey_Iterator end) override {return null;}
	virtual Value rereduce(ReducedRow_Iterator begin, ReducedRow_Iterator end) override {return null;}
};
...
public:
	...
	void send(const Str &txt) {send(std::string_view(txt));}
